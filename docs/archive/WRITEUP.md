# Historical draft — not current integration guidance

Retained for context only. Numerical results and exactness claims below are
superseded by [the current design](../../DESIGN.md) and generated reports.
Relative links in the original draft may refer to its former root location.
